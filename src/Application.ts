...
import { RequestHandler, LogLevel, Context } from './server';
...
export class Application {
     ...
     */
    use(middleware: Middleware<Context, any>) {
     ...
     */
    view(viewMiddlware: Middleware<Context, any>) {
     ...
     */
    error(errorMiddleware: Middleware<Context, any>) {
